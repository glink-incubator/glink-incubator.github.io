...
function init(){input.removeEventListener('focus',init);loadScript('/js/groupBy-700a0a22e5.min.js');loadScript('/js/flexsearch-e54a90f706.min.js',function(){const indexCfgDefaults={tokenize:'forward'}
